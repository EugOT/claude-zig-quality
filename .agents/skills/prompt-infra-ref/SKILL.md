...
`${ZIG_QM_PROMPT_INFRA_DIR}/` (set this env var to your local prompt-infra corpus root; the default is unset — the router degrades to no-corpus mode)
...
| `Implementing AGENTS.md for Executable AI Coding Context.md` | AGENTS.md executable context | writing AGENTS.md, AGENTS.md conventions, executable coding context |
...
| `zig Codex plugin with ZLS.md` | Zig + Codex plugin + ZLS | ZLS integration, Zig Codex plugin |
