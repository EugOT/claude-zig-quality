...
// templates/orbstack/arch-kcov-bootstrap.bash. Review and refresh the digest
// monthly with the Arch coverage template so package trust does not drift stale.
const DEFAULT_IMAGE =
